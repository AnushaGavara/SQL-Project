...
CREATE TABLE IF NOT EXISTS `mydb`.`Organiser` (
  `Organiser_ID` VARCHAR(5) NOT NULL,
  `Organiser_Name` CHAR(70) NOT NULL,
  `Organiser_Age` INT NOT NULL,
  `Organiser_Experience` INT NOT NULL,
  `Organisercol` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Event` (
  ...
  `Organiser_Organiser_ID` VARCHAR(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Post` (
  ...
  `Event_Organiser_Organiser_ID` VARCHAR(5) NOT NULL,
  PRIMARY KEY (`Post_ID`, `Event_Event_ID`, `Event_Organiser_Organiser_ID`),
  UNIQUE INDEX `Post_ID_UNIQUE` (`Post_ID` ASC) VISIBLE,
  INDEX `fk_Post_Event1_idx` (`Event_Event_ID` ASC, `Event_Organiser_Organiser_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Comment` (
  ...
  `Post_Event_Organiser_Organiser_ID` VARCHAR(5) NOT NULL,
  PRIMARY KEY (`Comment_ID`, `Post_Post_ID`, `Post_Event_Event_ID`, `Post_Event_Organiser_Organiser_ID`),
  UNIQUE INDEX `Comment_ID_UNIQUE` (`Comment_ID` ASC) VISIBLE,
  INDEX `fk_Comment_Post1_idx` (`Post_Post_ID` ASC, `Post_Event_Event_ID` ASC, `Post_Event_Organiser_Organiser_ID` ASC) VISIBLE,
  CONSTRAINT `fk_Comment_Post1`
    FOREIGN KEY (`Post_Post_ID` , `Post_Event_Event_ID` , `Post_Event_Organiser_Organiser_ID`)
    REFERENCES `mydb`.`Post` (`Post_ID` , `Event_Event_ID` , `Event_Organiser_Organiser_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Post_has_Tag` (
  ...
  PRIMARY KEY (`Post_Post_ID`, `Post_Event_Event_ID`, `Post_Event_Organiser_Organiser_ID`, `Tag_Tag_ID`),
  INDEX `fk_Post_has_Tag_Tag1_idx` (`Tag_Tag_ID` ASC) VISIBLE,
  INDEX `fk_Post_has_Tag_Post1_idx` (`Post_Post_ID` ASC, `Post_Event_Event_ID` ASC, `Post_Event_Organiser_Organiser_ID` ASC) VISIBLE,
